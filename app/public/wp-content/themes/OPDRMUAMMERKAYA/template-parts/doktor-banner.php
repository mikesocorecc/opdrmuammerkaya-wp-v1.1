        ...
        <div class="row">
            <div class="col-lg-7 offset-lg-0 order-lg-1 col-sm-8 offset-sm-2 col-10 offset-1 order-2">
                <div class="banner-content">
                    ...
                    <p class="banner-desc">
                    <p style="box-sizing: border-box; margin: 15px 0px 0px; padding: 0px 46px 0px 0px; list-style-type: none; font-size: 15px; line-height: 26px; color: #212529; font-family: Montserrat, sans-serif; text-align: left;">
